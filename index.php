...
/*
	...
	Plugin URI: https://linesh.com/projects/custom-adminbar-menus/
	...
	Text Domain: custom-adminbar-menus
*/
$version='19.05';
global $wp_version;
...
function cam_plugin_actions( $links, $file )	
{
	...
	if ($file == $plugin) {
	$links[] = '<a href="https://www.youtube.com/watch?v=3vkTCEsZSfY" target="_blank"><span class="dashicons dashicons-format-video"></span>' . __('Video','custom-adminbar-menus' ) . '</a>';
	$links[] = '<a href="https://linesh.com/make-a-donation/" target="_blank"><span class="dashicons dashicons-heart"></span>' . __('Donate','custom-adminbar-menus'  ) . '</a>';
	$links[] = '<a href="https://linesh.com/forums/forum/plugins/custom-adminbar-menus/" target="_blank"><span class="dashicons dashicons-sos"></span>' . __('Support', 'custom-adminbar-menus'  ) . '</a>';
	}
	return $links;
}
...
// Adding settings option for additional adminbar links  -------------->
	...
	function cam_register_fields() {
        ...
        add_settings_field(
			...
			'<label id="cam-additional-shortcuts-label" for="cam-additional-shortcuts">'.__('Show Admin shortcuts Links','custom-adminbar-menus') .'</label>',
	...
	function cam_fields_html() {
		...
		echo '</select>'.__('More WordPress admin menus shortcut links under "Site Menu" & "Add New" section in Adminbar. ','custom-adminbar-menus').'<a href="https://wordpress.org/plugins/custom-adminbar-menus/" target="_blank">'.__('Know More','custom-adminbar-menus').'</a></p>
		';
    }
...
// Custom Adminbar menu  -------------->
	function cam_adminbar_menus() {
		if( cam_main_site() && cam_is_s_admin() ){
			register_nav_menus(	array('cam_adminbar_menus' => __( 'C.A.M: Adminbar Menu','custom-adminbar-menus' )));
		}
	}
